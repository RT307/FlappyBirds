...
class Game:
    ...
    def spawn_pipe(self, x):
        ...
        self.pipes.append({'top': pg.Rect(x, 0, PIPE_WIDTH, h), 'bot': pg.Rect(x, h + GAP_SIZE, PIPE_WIDTH, HEIGHT - h - GAP_SIZE), 'passed': False})
    ...
    def draw(self):
        ...
        if self.lose:
            msg = self.font.render("GAME OVER - Pres 'R'", True, 'red')
